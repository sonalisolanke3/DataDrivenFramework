...
public class BaseTest {
	...
	public void setUp() {
		...
		driver.manage().timeouts()
				.implicitlyWait(java.time.Duration.ofSeconds(Integer.parseInt(config.getProperty("implicit.wait"))));
		wait = new WebDriverWait(driver, java.time.Duration.ofSeconds(Integer.parseInt(config.getProperty("explicit.wait"))));
		try {
